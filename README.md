...
Projekt skupiony na budowie modeli predykcyjnych określających aktywność biologiczną cząsteczek względem receptora serotoniny 5-HT2A na podstawie wektora cech numerycznych opisujących strukturę molekularną.
...
4. Redukcja wymiarowości (PCA) i analiza skupień.
